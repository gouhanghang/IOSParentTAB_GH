...
@protocol MultilevelMenuDelegates <NSObject>

- (void)Usertype:(NSMutableArray *)usertype;

@end
@interface MultilevelMenus : UIView
...
@property(nonatomic,assign) id<MultilevelMenuDelegates> delegate;
